...
export const PDF = {
  nl: {
    ...
    quoteTitle: 'Offerte',
    // A showroomaanbieding is a floor price/spec sheet with no customer — see routes/quotes.js.
    showroomTitle: 'Showroomaanbieding',
    showroomKickerPrefix: 'SHOWROOMAANBIEDING',
    showroomSubtitle: 'Prijsindicatie voor de showroom',
    showroomFooterValidity: 'Prijsindicatie voor de showroom — dit is geen persoonlijke offerte.',
  ...
  fr: {
    ...
    quoteTitle: 'Devis',
    showroomTitle: 'Offre showroom',
    showroomKickerPrefix: 'OFFRE SHOWROOM',
    showroomSubtitle: 'Indication de prix pour le showroom',
    showroomFooterValidity: 'Indication de prix pour le showroom — ceci n\'est pas un devis personnalisé.',
